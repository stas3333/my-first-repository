...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	// ваш код здесь
	formCaloriesRun := ((runningCaloriesMeanSpeedMultiplier * meanSpeed(action, duration) * runningCaloriesMeanSpeedShift) * weight / mInKm * duration * minInH)
	return formCaloriesRun
}
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	...
	formCaloriesWalking := ((walkingCaloriesWeightMultiplier*weight + (math.Pow(speedMsec, 2)/(height/cmInM))*walkingSpeedHeightMultiplier*weight) * duration * minInH)
	return formCaloriesWalking
}
...
func SwimmingSpentCalories(lengthPool, countPool int, duration, weight float64) float64 {
	// ваш код здесь
	formCaloriesSwimming := (swimmingMeanSpeed(lengthPool, countPool, duration) + swimmingCaloriesMeanSpeedShift) * swimmingCaloriesWeightMultiplier * weight * duration
	return formCaloriesSwimming
}
